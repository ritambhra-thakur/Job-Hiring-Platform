...
if database_log_enabled():
    ...
    class APILogsAdmin(admin.ModelAdmin, ExportCsvMixin):
        ...
        def changelist_view(self, request, extra_context=None):
            ...
            status_code_count_mode = filtered_query_set.values("id").values("status_code").annotate(total=Count("id")).order_by("status_code")
            ...
            extra_context = dict(
                analytics=analytics_model, status_code_count_keys=status_code_count_keys, status_code_count_values=status_code_count_values
            )
