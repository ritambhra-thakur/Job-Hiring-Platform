...
class APILoggerMiddleware:
    def __init__(self, get_response):
        ...
        if hasattr(settings, "DRF_API_LOGGER_SKIP_URL_NAME"):
            if type(settings.DRF_API_LOGGER_SKIP_URL_NAME) is tuple or type(settings.DRF_API_LOGGER_SKIP_URL_NAME) is list:
        ...
        if hasattr(settings, "DRF_API_LOGGER_SKIP_NAMESPACE"):
            if type(settings.DRF_API_LOGGER_SKIP_NAMESPACE) is tuple or type(settings.DRF_API_LOGGER_SKIP_NAMESPACE) is list:
